<template>
    <div class="asset_row">
        ...
        <p class="volume_day">{{asset.volume_day.toLocaleString(asset.denomination)}}</p>
...
export default class AssetRow extends Vue {
    ...
    get avgTxValue(): string {
        return (this.asset.txCount_day > 0) ? (this.asset.volume_day.div(this.asset.txCount_day)).toFixed(0) : "";
    }
